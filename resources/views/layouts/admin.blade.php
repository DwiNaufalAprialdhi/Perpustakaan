...
<head>
  ...
  <title>Perpustakaan Apps</title>

  <link rel="shortcut icon" href="{{ asset('app/img/perpustakaan.ico') }}">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboard">
        ...
        <div class="sidebar-brand-text mx-3">Perpustakaan Apps</div>
      </a>
      ...
      <!-- Nav Item - Pages Master Data Menu -->
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/peminjam">Anggota</a>
          </div>
        </div>
    </li>

      <!-- Nav Item - Pages Transaksi Peminjaman Menu -->
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="/transaksi">List</a>
          </div>
        </div>
      </li>
       ...
       <li class="nav-item">
        ...
        <div id="laporan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="/transaksi-masa-peminjaman">Masa Peminjaman</a>
            <a class="collapse-item" href="/transaksi-sudah-dikembalikan">Sudah Dikembalikan</a>
            <a class="collapse-item" href="/transaksi-belum-dikembalikan">Data Jatuh Tempo</a>
          </div>
        </div>
      </li>
      ...
      <div class="sidebar-heading">
        ...
        <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pengguna" aria-expanded="true" aria-controls="collapsePages">
          <i class="fas fa-user"></i>
          <span>Pengguna</span>
        </a>
        <div id="pengguna" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="/pengguna">Admin / Petugas</a>
          </div>
        </div>
      </li>
      @endif
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright / NJR 2020 &copy; dwinaufalaprialdhi</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
